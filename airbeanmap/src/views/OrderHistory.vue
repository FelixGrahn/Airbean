    ...
    >
      <div v-if="user.ordersum > 0">
        ...
        <span class="info" v-if="index == showruta">
          <ul>
            <li class="liststyle">
              <span class="infoleft">Item Name:</span
              ><span class="inforight">Amount</span>
            </li>
            <li
              v-for="(items, index) of $store.state.userlist[checkuser].history[
                index
              ].myitems"
              :key="index"
            >
              <span class="infoleft">{{ items.name }}</span
              ><span class="inforight">{{ items.amount }}</span>
            </li>
          </ul>
        </span>
      </div>
